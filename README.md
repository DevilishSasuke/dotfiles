...
| App                      | Download link                                                                         | Description             | VPN required |
|:------------------------ |:------------------------------------------------------------------------------------- |:-----------------------:|:------------:|
| **WinRAR**               | [local installer](./winrar/winrar-x64-701en.exe)                                      | archiver                | ❌            |
...
| App                              | Download link                                                                       | Description                      | VPN required |
|:-------------------------------- |:----------------------------------------------------------------------------------- |:--------------------------------:|:------------:|
| **GOM Player Plus v2.3.71.5335** | [local installer](./gom_player/GOM Player Plus 2.3.71.5335_portbl_by_Dodakaedr.exe) | comfortable video player version | ❌            |
